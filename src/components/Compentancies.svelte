...
<div>
	<section class="text-gray-200 rounded-lg bg-gray-800">
		<div class="max-w-6xl mx-auto px-5 py-24 ">
			<div class="text-center mb-20">
				...
				<p class="text-base leading-relaxed xl:w-2/4 lg:w-3/4 mx-auto">
					I have tried my hand at all the popular frameworks
				</p>
						...
						<div class="rounded bg-gray-800 p-4 transform translate-x-6 -translate-y-6  ">
							...
							<div class="flex-grow ">
								...
								<p class="leading-relaxed text-sm text-justify">
									Having built applications in all of the "big three" frameworks, I have arrived at
									my favourite and fourth one. Svlete
								</p>
							</div>
						</div>
					</div>
				...
				<div class="p-10 md:w-1/3 md:mb-0 mb-6 flex flex-col ">
					<div class="pattern-dots-md gray-light">
						<div class="rounded bg-gray-800 p-4 transform translate-x-6 -translate-y-6 ">
							...
							<div class="flex-grow">
								<h2 class="text-xl title-font font-medium mb-3">Langauges</h2>
								<p class="leading-relaxed text-sm text-justify">Javascript, Typescript, English</p>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="pattern-dots-md gray-light">
						<div class="rounded bg-gray-800 p-4 transform translate-x-6 -translate-y-6 ">
							...
							<div class="flex-grow">
								...
								<p class="leading-relaxed text-sm text-justify">
									I find that NestJs lends itself very well to the type of things that have needed
									so far
								</p>
							</div>
						</div>
